...
async function swap() {
    ...
    const slippage = 5
    const balanceOfToken1 = await token1Contract.balanceOf(deployer)
    console.log(`Token 1 balance of deployer is ${balanceOfToken1}`)
    ...
    const sushiswap = await swapContract.swapWithSushi(
        tokenInAddress,
        tokenOutAddress,
        amount,
        0,
